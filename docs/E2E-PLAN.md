...
- [ ] 上記の共有KV・全件モードを実サービスで検証し、artifactと回収結果を照合する。初回[実行35962599536](https://github.com/lycanthr0pes/IE_Event_Bot_fork/actions/runs/35962599536)は共有KVに既存値があり、fixture作成前に停止。空の専用KVでの再実行が必要。
